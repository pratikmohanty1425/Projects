create procedure st_getExternalMedicine
@appID bigint
as
select m.m_name as 'Medicine2',
...
end end end end end end end) as 'Dosage External' from PatientPrescription pp
left join medicine m
on m.m_id=pp.pip_medicineID
where pp.pip_appointmentID=@appID and m.m_type=1